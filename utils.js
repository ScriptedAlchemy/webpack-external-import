...
var getChunkPath = function getChunkPath(basePath, nameSpace, module) {
  ...
  if (
    ((_window = window) === null || _window === void 0
      ? void 0
      : _window.entryManifest[nameSpace]) &&
    ((_window2 = window) === null || _window2 === void 0
      ? void 0
      : _window2.entryManifest[nameSpace][module]) &&
    ((_window3 = window) === null || _window3 === void 0
      ? void 0
      : _window3.entryManifest[nameSpace][module].path)
  ) {
    pathString = [basePath, window.entryManifest[nameSpace][module].path];
  } else if (
    ((_window4 = window) === null || _window4 === void 0
      ? void 0
      : _window4.entryManifest[nameSpace]) &&
    ((_window5 = window) === null || _window5 === void 0
      ? void 0
      : _window5.entryManifest[nameSpace]["".concat(module, ".js")]) &&
    ((_window6 = window) === null || _window6 === void 0
      ? void 0
      : _window6.entryManifest[nameSpace]["".concat(module, ".js")].path)
  ) {
    pathString = [
      basePath,
      window.entryManifest[nameSpace]["".concat(module, ".js")].path
    ];
  }
...
var getChunkDependencies = function getChunkDependencies(
  basePath,
  nameSpace,
  module
) {
  ...
  if (
    ((_window7 = window) === null || _window7 === void 0
      ? void 0
      : _window7.entryManifest[nameSpace]) &&
    ((_window8 = window) === null || _window8 === void 0
      ? void 0
      : _window8.entryManifest[nameSpace][module]) &&
    ((_window9 = window) === null || _window9 === void 0
      ? void 0
      : _window9.entryManifest[nameSpace][module].dependencies)
  ) {
    window.entryManifest[nameSpace][module].dependencies.forEach(function(
      file
    ) {
      if (!__webpack_modules__[file.id]) {
        file.sourceFiles.forEach(function(chunkFile) {
          ...
          return dependencyPaths.push(
            basePath +
              ((_window10 = window) === null || _window10 === void 0
                ? void 0
                : _window10.entryManifest[nameSpace][chunkFile].path)
          );
        });
      }
    });
  } else if (
    ((_window11 = window) === null || _window11 === void 0
      ? void 0
      : _window11.entryManifest[nameSpace]) &&
    ((_window12 = window) === null || _window12 === void 0
      ? void 0
      : _window12.entryManifest[nameSpace]["".concat(module, ".js")]) &&
    ((_window13 = window) === null || _window13 === void 0
      ? void 0
      : _window13.entryManifest[nameSpace]["".concat(module, ".js")]
          .dependencies)
  ) {
    window.entryManifest[nameSpace][
      "".concat(module, ".js")
      ...
      if (!__webpack_modules__[file.id]) {
        file.sourceFiles.forEach(function(chunkFile) {
          ...
          return dependencyPaths.push(
            basePath +
              ((_window14 = window) === null || _window14 === void 0
                ? void 0
                : _window14.entryManifest[nameSpace][chunkFile].path)
          );
        });
      }
    });
...
var importWithDependencies = function importWithDependencies(
  basePath,
  nameSpace,
  module
) {
...
var importDependenciesOf = function importDependenciesOf(
  basePath,
  nameSpace,
  module
) {
